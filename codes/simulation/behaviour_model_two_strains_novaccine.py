...
def SEIR_behaviour(start_date_org,
    ...
    for t in np.arange(1, T, 1):
        ...
        if vaccine==True:
            if t >= T_nonvax + 1:
                if basin == 'Lombardy' or basin == 'Sao Paulo':
                    V_S, V_S_NC = get_vaccinated(basin, rV_age, compartments[:, :, t - 1].ravel('F'), t - 1 - T_nonvax,
                                                 start_date,
        ...
        infections[:, (t - 1)] = compartments[6, :, t] + compartments[2, :, t] + compartments[9, :, t] + compartments[12, :, t]
