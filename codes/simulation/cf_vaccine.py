...
def run_cf(basin):
    ...
    for idx, data in pos.iterrows():
        ...
        if basin == 'London':
            ...
            death_sim_novax, infection_sim_novax = SEIR(start_date_org=start_date_org, end_date=end_date, start_week_delta=int(t0),
                                          vaxstart_date=vaxstart_date,
                                          i0_q=i0_q, r0_q=r0_q, R0=R0,
                                          eps=eps, mu=mu, ifr=IFR, Delta=Delta,
                                          VE=VE, VES=VES,
            ...
            death_sim_novax, infection_sim_novax = SEIR(start_date_org=start_date_org,
