...
from variation_model_single_strain import SEIR_variation
import pyabc
import os
import uuid
...
def run_calibration(basin, start_month, start_day, end_month, end_day, start_vax_month, start_vax_day):
    ...
    # deaths real
    deaths_real = country_dict["deaths"].loc[(country_dict["deaths"]["year_week"] >= "2020-50") & \
    ...
    history = calibration(SEIR_variation,
                        prior=Distribution(
                                    ...
                                    i0_q = RV("uniform", 1, 50 - 1),  # (20*new_pos-new_pos)
                                    r0_q = RV("uniform", 0.1, 10 - 0.1),
...
if __name__ == "__main__":
    ...
    #startdates = (11, 1)
    run_calibration("London", 11, 2, 7, 4, 12, 8)